...
| --- | --- | --- | --- | --- | --- |
| `ibm-watsonx-orchestrate` | `2.14.0` | MIT License in PyPI metadata | <https://pypi.org/project/ibm-watsonx-orchestrate/2.14.0/> | Installed by setup guide and referenced from `.bob/mcp.json` | Generate a resolved dependency report before distributing any environment or image. |
| `ibm-watsonx-orchestrate-mcp-server` | `2.14.0` | MIT License in PyPI metadata | <https://pypi.org/project/ibm-watsonx-orchestrate-mcp-server/2.14.0/> | Installed by setup guide and referenced from `.bob/mcp.json` | Generate a resolved dependency report before distributing any environment or image. |
...
The Python packages `ibm-watsonx-orchestrate==2.14.0` and
`ibm-watsonx-orchestrate-mcp-server==2.14.0` are listed as MIT-licensed packages
